            ...
            <div class="myorder_Content_product">
                <div class="myorder_Content_productShipper myorderdetail_prevtitle">
                    <div class="myorderdetail_prev">
                        ...
                        <a href="{{ route('myOrder') }}" class="myorderdetail_prevName" style="text-decoration: none">TRỞ
                            LẠI</a>
                    </div>
                    ...
                    @if ($detail->variant && $detail->variant->product)
                        ...
                        <div class="myorder_Content_productContent">
                            <div class="myorder_Content_productContentDecripsion">
                                <img src="{{ asset($imgPath) }}" alt="{{ $detail->variant->product->productname }}"
                                ...
                                <div class="myorder_Content_productContent_decription">
                                    ...
                                    <span class="myorder_Content_productContent_classi">Phân Loại :
                                        {{ $detail->variant->color }},{{ $sizeMap[$detail->size] ?? $detail->size }}</span>
                            ...
                            <div class="myorder_Content_productContentPrice">
                                <span
                                    class="myorder_Content_productContentPriceNew">{{ number_format($itemTotal) }}đ</span>
                            </div>
                        </div>
                    @endif
                @endforeach
                ...
                <div class="myorder_Content_productPayBill">
                    ...
                    <div class="payBillendContent">
                        <div class="payBillendContent_tienhang">
                            ...
                            <span
                                class="payBillendContent_tienhang_nameSum colorBlue">{{ number_format($order->totalamount) }}đ</span>
                        </div>
