                                ...
                                <a href="{{ route('productDetail', $product->product_id) }}"
                                    ...
                                    <div class="home-product-item">
                                        ...
                                        <div class="home-product-item__price">
                                            ...
                                            @if ($representVariant)
                                                <span
                                                    class="home-product-item__price-old">{{ number_format($representVariant->price * 1.2) }}đ</span>
                                                <span
                                                    class="home-product-item__price-current">{{ number_format($representVariant->price) }}đ</span>
                                            @else
