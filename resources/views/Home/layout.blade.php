...
<head>
    ...
    <link href="https://fonts.googleapis.com/css2?family=Roboto:ital,wght@0,100..900;1,100..900&display=swap"
        rel="stylesheet">
    <title>@yield('title', 'AURA-BUTIQUE')</title>
</head>
    ...
    <div class="app">
                            ...
                            <div class="header__qr">
                                ...
                                <div class="header__qr-apps">
                                    <a href="#" class="header__qr-link">
                                        <img src="{{ asset('assets/img/apstore.png') }}" alt="Google Play"
                                            class="header__qr-download-img">
                                    </a>

                                    <a href="#" class="header__qr-link">
                                        <img src="{{ asset('assets/img/google.png') }}" alt="App Store"
                                            class="header__qr-download-img">
                                    </a>
                    ...
                    <ul class="header__navbar-list">
                                ...
                                <ul class="header__notify--list">
                                    <li class="header__notify--item">
                                        <a href="#" class="header__notify--link">
                                            <img src="{{ asset('assets/img/sandan1.jpg') }}" alt=""
                                                class="header__notify--img">
                                            <div class="header__notify--info">
                                                <span class="header__notify--name">Áo Thun Trơn 100% Cotton Comfitex màu sắc Fabric 240Gsm Form Oversize
                                                </span>
                                                <span class="header__notify--descriotion">Với chất liệu da cao cấp, siêu
                                                     mềm</span>
                                            </div>
                                        </a>
                                    </li>
                                    ...
                                    <li class="header__notify--item">
                                        <a href="" class="header__notify--link">
                                            <img src="{{ asset('assets/img/sandanNui.jpg') }}" alt=""
                                                class="header__notify--img">
                                            <div class="header__notify--info">
                                                <span class="header__notify--name">Váy Ren Hoa Timi Dáng Xòe Bồng Bềnh, Đầm Nữ Kiểu Dáng 2 Dây Phối Trễ Vai Sang Chảnh
                                                     </span>
                                                <span class="header__notify--descriotion">Giá chỉ còn 375.000 (giá gốc:
                                                    1.250.000vnd). </span>
                                            </div>
                                        </a>
                                    </li>
                                    ...
                                    <li class="header__notify--item">
                                        <a href="" class="header__notify--link header__notify--link--viewed">
                                            <img src="{{ asset('assets/img/giaythethao1.jpg') }}" alt=""
                                                class="header__notify--img">
                                            <div class="header__notify--info">
                                                <span class="header__notify--name">chính thức ra mắt dòng sản phẩm
                                                    đầm dạ hội </span>
                                                <span class="header__notify--descriotion"> Chiếc váy Timi là lựa chọn không thể thiếu cho nàng yêu phong cách công chúa hiện đại</span>
                                            </div>
                                        </a>
                                    </li>
                                </ul>
                        ...
                        @guest
                            <a style="text-decoration: none;" href="{{ route('register') }}">
                                <li class="header__navbar-item header__navbar-item-bold header__navbar-item--separete">Đăng
                                    kí</li>
                            </a>
                        ...
                        @auth
                            ...
                            <li class="header__navbar-item header__navbar-user">
                                <img src="{{ asset('assets/img/avata.jpg') }}" alt=""
                ...
                <div class="header-with-search">
                    <div class="header__logo">
                        <a href="/" class="header__logo-link"><!-- href="/" tự trở về trang chủ -->
                            ...
                            <img src="/assets/img/z7277539773361_350fba579fade980cfbe4b151b3ce070-removebg-preview.png"
                                alt="" class="logo_ShopGiay">
                        </a>
                    </div>
                    ...
                    <div class="header__cart">
                        <div class="header__cart-warp">
                            ...
                            <div
                                class="header__cart-list {{ ($global_cart_count ?? 0) == 0 ? 'header__cart-list--no-cart' : '' }}">


                                @if (($global_cart_count ?? 0) == 0)
                                    {{-- hiển thị khi giỏ hàng trống --}}
                                    <img src="{{ asset('assets/img/no_cart.png') }}" alt=""
                                            ...
                                            @foreach ($global_cart->details as $detail)
                                                @if ($detail->variant && $detail->variant->product)
                                                    ...
                                                    <li class="header__cart-item"
                                                        id="mini-cart-item-{{ $detail->cartdetail_id }}">
                                                        ...
                                                        <div class="header__cart-item-info">
                                                            <div class="header__cart-item-head">
                                                                <h5 class="header__cart-item-name">
                                                                    {{ $detail->variant->product->productname }}</h5>
                                                                <div class="header__cart-item-price-wrap">
                                                                    <span
                                                                        class="header__cart-item-price">{{ number_format($detail->unitprice) }}đ</span>
                                                                    <span class="header__cart-item-toantu">x</span>
                                                                    <span
                                                                        class="header__cart-item-soluong">{{ $detail->quantity }}</span>
                                                                </div>
                                                            </div>

                                                            <div class="header__cart-item-body">
                                                                <span class="header__cart-item-decriptions">Phân loại :
                                                                    {{ $detail->size }},
                                                                    {{ $detail->variant->color }}</span>
                                                                <a href="#" style="text-decoration: none;"
                                                                    class="header__cart-item-remove mini-cart-delete-btn"
                                                                    data-id="{{ $detail->cartdetail_id }}">Xoá</a>
                                                            </div>
                                                        </div>
                                                    </li>
                                                @endif
        ...
        <footer class="footer">
            <div class="grid">
                <div class="grid__row">
                    ...
                    <div class="grid__column-2-4">
                        ...
                        <ul class="footer__list">
                            <li class="footer__list-item">
                                <a href="" class="footer__list-item-link">Đầm</a>
                            </li>
                            <li class="footer__list-item">
                                <a href="" class="footer__list-item-link">Váy</a>
                            </li>
                            <li class="footer__list-item">
                                <a href="" class="footer__list-item-link">Áo thun</a>
                            </li>
                            <li class="footer__list-item">
                                <a href="" class="footer__list-item-link">Quần jean</a>
                            </li>
                        </ul>
                    </div>
                    <div class="grid__column-2-4">
                            ...
                            <div class="footer__down-apps">
                                <a href="#" class="footer__down-apps-link">
                                    <img src="{{ asset('assets/img/google.png') }}" alt=""
                                        class="footer__down-apps-img">
                                </a>
                                <a href="#" class="footer__down-apps-link">
                                    <img src="{{ asset('assets/img/apstore.png') }}" alt=""
                                        class="footer__down-apps-img">
                                </a>
                            </div>
                        </div>
            ...
            <div class="footer__bottom">
                <div class="grid">
                    <div class="footer_text">© 2025 - Bản quyền thuộc về AURA BUTIQUE</div>
                </div>
            </div>
            D
        </footer>
                ...
                try {
                    ...
                    if (response.ok && result.success) {
                        ...
                        if (result.totalQuantity == 0) {
                            document.querySelector('.header__cart-list').classList.add(
